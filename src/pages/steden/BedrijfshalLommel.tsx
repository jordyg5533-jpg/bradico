...
const city: CityData = {
  ...
  canonical: "https://www.bv-bradico.be/bedrijfshal-lommel",
...
<p>Elk project in Lommel wordt behandeld met dezelfde aanpak: grondig terreinbezoek, technisch ontwerp op maat, vaste-prijs offerte binnen 48 uur en een sleutelklare oplevering inclusief vergunningsbegeleiding. Één aanspreekpunt, geen verrassingen.</p>`,
