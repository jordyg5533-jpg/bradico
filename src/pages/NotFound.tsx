    ...
    <>
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex flex-1 flex-col items-center justify-center text-center px-4 py-32">
          <p className="text-6xl font-black" style={{ color: "hsl(214 82% 56%)" }}>404</p>
          ...
          <a href="/" className="mt-8 inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-bold text-white shadow-lg transition-all hover:brightness-110" style={{ background: "hsl(214 82% 56%)" }}>
            Terug naar home
          </a>
        </main>
        <Footer />
